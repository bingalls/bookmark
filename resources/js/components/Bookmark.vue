            ...
            <section class="main" v-show="items.length" v-cloak>
                ...
                <ul class="item-list">
                    <li v-for="item in items"
                        ...
                        <div class="view">
                            <input class="toggle" type="checkbox" v-model="item.is_complete"
                                   v-on:change="activeItemNow(item.id, item.is_complete)">
                            <label @dblclick="editItem(item)" for="edit">{{ item.name }}</label>
                            <button class="destroy" @click="deleteItem(item.id)"></button>
                        </div>
                        <input class="edit" type="url"
                               id="edit"
                               v-model="name"
